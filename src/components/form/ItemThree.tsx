export default function ItemThree() {
  return (
    <div className="flex flex-col gap-5 p-5">
      <h1 className="font-extrabold text-gray-600">1: فروشنده</h1>
      <div className="flex items-center gap-8">
        <div className="flex flex-col gap-1 w-1/6" dir="rtl">
          <label htmlFor="" className="font-extrabold text-gray-600" dir="rtl">
            نام و نام خانوادگی
          </label>
          <input
            type="text"
